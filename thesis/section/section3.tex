...
and mapping is, p \-> (q,r) which means SLD2 and SLD3 are clustered with SLD1
	then number of links of the clustered hosting infrastructure is p + q + r (Links are counted irrespective of their repetitiveness in other SLDs) 
...
and mapping is, x \-> (y,z) which means SLD2 and SLD3 are clustered with SLD1
	then number of IP addresses of the clustered hosting infrastructure is set(x,y,z) (Non repetitive IP addresses)
...
and mapping is, i\->(j,k) which means SLD2 and SLD3 are clustered with SLD1
	then number of BGP prefixes of the clustered hosting infrastructure is set(i,j,k) (Non repetitive bgp prefixes)
...
and mapping is, a->(b,c) which means SLD2 and SLD3 are clustered with SLD1
	then number of ASNs of the clustered hosting infrastructure is set(a,b,c) (Non repetitive ASNs)
